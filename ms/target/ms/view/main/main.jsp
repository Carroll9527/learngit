...
<html>
  ...
  <body class="easyui-layout">
	...
	<div data-options="region:'south',split:true,border:false" style="height: 30px;overflow:hidden;">
		<div class="panel-header" style="border: none;text-align: center;" >CopyRight &copy; 2012 Swing 版权所有. &nbsp;&nbsp;官方网址:www.voyagemedia.com.cn  &nbsp;&nbsp;京ICP备05070602号</div>
	</div>
	<!-- 中间内容页面 -->
	<div data-options="region:'center'" >
		<div class="easyui-tabs" id="tab-box" data-options="fit:true,border:false">
			<div title="Welcome" overflow:hidden;"> 
			<iframe style="width:100%;height:100%" src="http://www.voyagemedia.com.cn/"></iframe>
