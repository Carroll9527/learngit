...
public class StringUtil
{
	...
	/**
	 * 寰楀埌闈炵┖鐨勫瓧绗︿覆锛岃嫢瀛楃涓插璞′负null锛屽垯杩斿洖""銆�
	 * @param objValue Object寰呰浆鎹㈢殑鍘熷瓧绗︿覆瀵硅薄
	...
	/**
	 * 寰楀埌闈炵┖鐨勫瓧绗︿覆锛岃嫢瀛楃涓蹭负null锛屽垯杩斿洖""銆�
	 * @param strValue String寰呰浆鎹㈢殑鍘熷瓧绗︿覆
	 * @return String 杞崲鍚庣殑瀛楃涓�
	 * */
...
//	/**
//	 * 浣跨敤姝ｅ垯琛ㄨ揪寮忚繘琛屽瓧绗︿覆鍐呭鏇挎崲
//	 * @param regularExpression 姝ｅ垯琛ㄨ揪寮�
//	 * @param sub 鏇挎崲鐨勫瓧绗︿覆
//	 * @param input 瑕佹浛鎹㈢殑瀛楃涓�
...
//	}
	...
	/**
	 * 鍒ゆ柇涓�涓瓧绗︿覆涓槸鍚﹀寘鍚鍚堟鍒欒〃杈惧紡瀹氫箟鐨勫尮閰嶆潯浠剁殑瀛愪覆
	 * @param regularExpression - 姝ｅ垯琛ㄨ揪寮�
	 * @param input - 寰呮鏌ュ瓧绗︿覆
	 * @return - 鑻ヨ緭鍏ュ瓧绗︿覆涓寘鍚鍚堟鍒欒〃杈惧紡瀹氫箟鐨勫尮閰嶆潯浠剁殑瀛愪覆锛屽垯杩斿洖true锛屽惁鍒欒繑鍥瀎alse
	 */
//	//姝ｅ垯琛ㄨ揪寮忓尮閰嶅垽鏂�
...
//	}
	...
	/**
	 * 鐢�"0"琛ヨ冻涓�涓瓧绗︿覆鍒版寚瀹氶暱搴�
	 * @param str -  婧愬瓧绗︿覆
	 * @param size - 琛ヨ冻鍚庡簲杈惧埌鐨勯暱搴�
	 * @return - 琛ラ浂鍚庣殑缁撴灉
	 */
	...
	/**
	 * 鏍规嵁瀛楃涓诧紙鏂囦欢绫诲瀷鎴栬�呭琛岃緭鍏ョ被鍨嬶級鑾峰彇瀛楃涓叉暟缁�
	 * @param str1 String 杈撳叆瀛楃涓�
	...
	/**
	 * 閫氳繃瀛楃涓茶浆鎹㈡垚鐩稿簲鐨勬暣鍨嬶紝骞惰繑鍥炪��
	 * @param strValue String 寰呰浆鎹㈢殑瀛楃涓�
	 * @return int 杞崲瀹屾垚鐨勬暣鍨�
	 * */
	...
	/**
	 * 閫氳繃瀛楃涓茶浆鎹㈡垚鐩稿簲鐨凞OUBLE锛屽苟杩斿洖銆�
	 * @param strValue String 寰呰浆鎹㈢殑瀛楃涓�
	 * @return double 杞崲瀹屾垚鐨凞OUBLE
	 * */
	...
	/**
	 * 閫氳繃瀛楃涓茶浆鎹㈡垚鐩稿簲鐨勭煭鏁村瀷锛屽苟杩斿洖銆�
	 * @param strValue String 寰呰浆鎹㈢殑瀛楃涓�
	 * @return short 杞崲瀹屾垚鐨勭煭鏁村瀷
	 * */
	...
	/**
	 * 閫氳繃瀛楃涓茶浆鎹㈡垚鐩稿簲鐨勯暱鏁村瀷锛屽苟杩斿洖銆�
	 * @param strValue String 寰呰浆鎹㈢殑瀛楃涓�
	 * @return long 杞崲瀹屾垚鐨勯暱鏁村瀷
	 * */
	...
	/**
	  * 闄嶅瓧绗︿覆杞崲鎴愮粰瀹氶暱搴︾殑瀛楃涓诧紝濡傝秴鍑虹殑璇濇埅鏂紝骞跺湪鏈�鍚庝互涓や釜鐐圭粨灏�
	  * @param str String
	  * @param length int
	  * @return String
	  */
	...
	//姝ゅ嚱鏁板墠鍙颁娇鐢ㄤ腑锛岃鍕块殢渚夸慨鏀癸紝涓嶇劧浼氶�犳垚鏄剧ず娣蜂贡(浠ュ墠淇敼鐗堟湰鍦ㄤ笅鏂规敞閲婁腑)
	...
	//	姝ゅ嚱鏁板悗鍙颁娇鐢ㄤ腑锛岃鍕块殢渚夸慨鏀癸紝涓嶇劧浼氶�犳垚鏄剧ず娣蜂贡(浠ュ墠淇敼鐗堟湰鍦ㄤ笅鏂规敞閲婁腑)
...
//		s = Replace(s, " ", "&nbsp;");
	...
	*/
	 ...
	 * 
	 * <br>
	 * <b>鍔熻兘锛�</b>灏嗗瓧绗︿覆杞垚list<br>
	 * <b>浣滆�咃細</b>缃楁辰鍐�<br>
	 * <b>鏃ユ湡锛�</b> Oct 28, 2011 <br>
	 * @param exp 鍒嗗壊绗� 濡�","
	 * @param value 
	 * @return
	 */
	 ...
	 * 
	 * <br>
	 * <b>鍔熻兘锛�</b>鏁板瓧杞崲鎴愬瓧绗︿覆<br>
	 * <b>浣滆�咃細</b>缃楁辰鍐�<br>
	 * <b>鏃ユ湡锛�</b> Jul 30, 2011 <br>
	 * @param arrs
	 * @return
	 */
	...
	/**
	 * 鏍规嵁杈撳叆鐨勯暱搴︽埅鍙栧瓧绗︿覆锛屽崟涓崟璇嶈秴杩囪緭鍏ラ暱搴︾殑寮哄埗鍔�<BR>鎹㈣
	 * @param str 杈撳叆鐨勫瓧绗︿覆
	 * @param len 杈撳叆鐨勯暱搴�
	 * @return 澶勭悊杩囧悗鐨勫瓧绗︿覆
	 */
	...
	/**
	 * 缂栫爜杞崲锛屼粠unicode杞崲涓篏BK
	 * @param str 杈撳叆瀛楃涓�
	 * @return str缂栫爜杞崲鍚庣殑瀛楃涓�
	...
	/**
	 * 缂栫爜杞崲锛屼粠GBK杞崲涓簎nicode
	 * @param str 杈撳叆瀛楃涓�
	 * @return str 缂栫爜杞崲鍚庣殑瀛楃涓�
	 * @throws UnsupportedEncodingException
	 */
...
//		//		String aaa = "涓枃涓枃涓枃bcdefghijk";
//
...
//
	 ...
	 * 
	 * <br>
	 * <b>鍔熻兘锛�</b>杩斿洖string鍨嬬殑瀛楄妭鏁�<br>
	 * <b>浣滆�咃細</b>缃楁辰鍐�<br>
	 * <b>鏃ユ湡锛�</b> Sep 2, 2011 <br>
	 * @param str
	 * @return
	 */
	...
	public static String getByteStr(String str,int limitLen){
	 ...
	 /**
     *@param  content 鍐呭
     *@param  length 鎸囧畾闀垮害銆� 瓒呭嚭杩欎釜闀垮害灏辨埅鍙栧瓧绗︿覆銆�
     *@param  padding 瓒呭嚭闀垮害鍚庯紝灏惧姞涓婂瓧绗︼紝濡�"..."锛屽彲浠ヤ负绌�
     *@return 杩斿洖缁撴灉 濡傛灉鍐呭娌℃湁瓒呭嚭鎸囧畾鐨勯暱搴︺�傚垯杩斿洖鍘熷瓧绗︿覆锛岃秴鍑洪暱搴﹀悗鍒欐埅鍙栧埌鎸囧畾鐨勯暱搴︾殑鍐呭
     */
    public static String subStr(String content,Integer length,String padding) throws UnsupportedEncodingException{
    	...
    	//濡傛灉鍐呭涓虹┖锛屾垨鑰呭皬浜庢寚瀹氱殑闀垮害銆傚垯杩斿洖鍘熷唴瀹�
