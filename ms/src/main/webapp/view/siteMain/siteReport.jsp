...
      </div>   
		...
		<!-- <div id="dlg3" class="easyui-dialog"
			style="width: 1000px; height: 700px;" closed="true"
			buttons="#dlg-buttons2">
 ...
 $('#mm').menu('show', { left: e.pageX, top: e.pageY }); e.preventDefault();
		...
		<form id="listForm" method="post">
			<table id="data-list" allowCellWrap="true"></table>
		</form>
		...
		<div id="edit-win" class="easyui-dialog" title="Basic window"
			...
			<form id="editForm" class="ui-form" method="post">
				...
				<div class="ui-edit">
					...
					<div class="fitem">
						<label>拜访时间:</label><input class="easyui-validatebox" type="text"
							name="visitTime">
					</div>
					<div class="fitem">
						<label>拜访内容:</label>
				...
				<div class="fitem">
					<label>下周计划:</label> 
					<textarea class="easyui-validatebox" name="nextWeekPlan"></textarea>	
				</div>
				<div class="fitem">
					<!-- <label>区域部门:</label>  -->
	...
	<script type="text/javascript"
		src="${msUrl}/js/ux/siteMain/siteReport.js"></script>
	<script type="text/javascript"
